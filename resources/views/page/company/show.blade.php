          ...
          <div class="w-full grid grid-cols-1 my-5">
            <div class="col-span-1">
              <div class="w-1/2 mx-auto">
                <form>
                  <div class="flex items-center justify-center size-36 mb-7 mx-auto">
                    <div class="rounded-lg overflow-hidden border bg-gray-600">
                  ...
                  <div class="my-2">
                    ...
                    <x-input-error :messages="$errors->get('website')" class="mt-2" readonly />
                  </div>
